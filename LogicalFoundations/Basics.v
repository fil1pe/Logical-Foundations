...
Example test_bin_incr2: incr (B (B (B (A (B Z))))) = A (A (A (B (B Z)))).
Proof. reflexivity.  Qed.
Example test_bin_incr3: incr (B (A (A (A (B Z))))) = A (B (A (A (B Z)))).
Proof. reflexivity.  Qed.

Example test_bin_to_nat1: bin_to_nat (A (B (B Z))) = 6.
Proof. reflexivity.  Qed.
Example test_bin_to_nat2: bin_to_nat (A (A (A (A (A (B Z)))))) = 32.
Proof. reflexivity.  Qed.
Example test_bin_to_nat3: bin_to_nat (B (A (A (A (B Z))))) = 17.
Proof. reflexivity.  Qed.
